...
const WORK_LABEL = 'Trabalhando';
const BREAK_LABEL = 'Descansando';
const START_LABEL = 'Iniciar';
const STOP_LABEL = 'Pausar';

let interval = 0;

export default class PomodoroTimerScreen extends React.Component {
  constructor(props) {
    super(props);
      ...
      <View style={{ flex: 1 }}>
        ...
        <View style={styles.container}>
          ...
          <View style={styles.inputContainer}>
            <Text style={styles.inputLabel}>Minutos para trabalhar:</Text>
            <TextInput
          ...
          <View style={styles.inputContainer}>
            <Text style={styles.inputLabel}>Minutos para descansar:</Text>
            <TextInput
